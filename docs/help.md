...
You can subscribe to the (infrequent) [**FastAPI and friends**](https://fastapi.tiangolo.com/newsletter/) to stay updated about:
...
You can "star" Asyncer in GitHub (clicking the star button at the top right): [https://github.com/fastapi/asyncer](https://github.com/fastapi/asyncer). ⭐️

By adding a star, other users will be able to find it more easily and see that it has been already useful for others.

## Watch the GitHub repository for releases

You can "watch" Asyncer in GitHub (clicking the "watch" button at the top right): [https://github.com/fastapi/asyncer](https://github.com/fastapi/asyncer). 👀
...
[Tweet about **Asyncer**](https://twitter.com/compose/tweet?text=I'm loving Asyncer because... https://github.com/fastapi/asyncer cc: @tiangolo) and let me and others know why you like it. 🎉
...
* [GitHub Discussions](https://github.com/fastapi/asyncer/discussions/categories/questions?discussions_q=category%3AQuestions+is%3Aunanswered)
* [GitHub Issues](https://github.com/fastapi/asyncer/issues?q=is%3Aissue+is%3Aopen+sort%3Aupdated-desc+label%3Aquestion+-label%3Aanswered+)
...
You can [create a new issue](https://github.com/fastapi/asyncer/issues/new/choose) in the GitHub repository, for example to:
...
If you would like to add a new dependency, create a new [Discussion](https://github.com/fastapi/asyncer/discussions/categories/questions) to explain why.
...
Join the 👥 [FastAPI and Friends Discord chat server](https://discord.gg/VQjSZaeJmf) 👥 and hang out with others in the community. There's an `#asyncer` channel.

/// tip

For questions, ask them in [GitHub Discussions](https://github.com/fastapi/asyncer/discussions/new?category=questions), there's a much better chance you will receive help there.
