...
Security is very important for Asyncer and its community. 🔒

Learn more about it below. 👇

## Versions

The latest version of Asyncer is supported.

You are encouraged to write tests for your application and update your Asyncer version frequently after ensuring that your tests are passing. This way you will benefit from the latest features, bug fixes, and **security fixes**.

If you use AI coding agents, use the bundled [Library Skills](https://library-skills.io/) to make your agents use the latest best practices defined by Asyncer, bundled with your installed Asyncer version:
...
The usage of Asyncer described in the docs is supported.

Using undocumented parts of the code, or writing apps in ways that are not described in the docs, is not supported.

Vulnerabilities caused by apps that incorrectly use Asyncer (e.g. by using patterns not documented in the docs) are considered vulnerabilities in those apps, not in Asyncer.

## Reporting a Vulnerability

If you find a vulnerability, please report it using [GitHub's private vulnerability reporting](https://github.com/fastapi/asyncer/security).
